...
import { systemTypeElement } from '../../interface/system-type-element';
...
export class systemTypeElementUpdateComponent extends systemTypeElementDataForm implements OnInit {
  form: FormGroup;
  loading = true;
  register = false;
  @Input() modal = false;
