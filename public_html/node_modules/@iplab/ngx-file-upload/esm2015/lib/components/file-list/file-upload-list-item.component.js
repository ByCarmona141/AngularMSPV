...
import * as ɵngcc2 from './file-upload-icon.component';
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FileUploadListItemComponent, [{
    ...
    }], function () { return [{ type: ɵngcc1.FileUploadService }]; }, { index: [{
            type: Input
        }], file: [{
            type: Input
        }], control: [{
