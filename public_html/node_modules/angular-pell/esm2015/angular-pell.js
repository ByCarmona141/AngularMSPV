...
function PellComponent_button_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PellComponent_button_3_Template_button_click_0_listener() { const action_r2 = ctx.$implicit; return action_r2.result(); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const action_r2 = ctx.$implicit;
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMap(ctx_r1.actionButtonClass);
    ɵngcc0.ɵɵproperty("title", action_r2.title)("innerHTML", action_r2.icon, ɵngcc0.ɵɵsanitizeHtml);
} }
const actions = {
    bold: {
        icon: '<b>B</b>',
...
PellModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PellModule });
PellModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PellModule_Factory(t) { return new (t || PellModule)(); }, imports: [[
            CommonModule
        ]] });
/** @nocollapse */
PellModule.ctorParameters = () => [];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PellModule, { declarations: function () { return [PellComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [PellComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PellModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule
...
export { PellModule, PellComponent as ɵa };
